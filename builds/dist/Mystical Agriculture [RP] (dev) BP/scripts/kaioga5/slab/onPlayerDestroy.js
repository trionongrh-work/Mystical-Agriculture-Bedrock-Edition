...
system.beforeEvents.startup.subscribe(eventData => {
    ...
    eventData.blockComponentRegistry.registerCustomComponent('kai:on_player_destroy_slab', {
        ...
        onPlayerDestroy(e) {
            ...
            let slabItem = perm.getItemStack(1);
            if (slabItem) {

                let state = e.destroyedBlockPermutation.getAllStates()

                if (state["kai:double"]) {
                    slabItem = perm.getItemStack(2);
                }
